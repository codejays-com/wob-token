...
contract WorldOfBlastDrop is Ownable {
    ...
    address public USDB_ADDRESS = 0x4200000000000000000000000000000000000022; //0x4300000000000000000000000000000000000003;
    address public WETH_ADDDRES = 0x4200000000000000000000000000000000000023; //0x4300000000000000000000000000000000000004;
    address public CONTRACT_NFT = 0xA709D6D2D71b3f9961980208F5e4Be1Fe664815d; //0xFB7acDaE5B59e9C3337203830aEC1563316679E6;
    ...
    function updateWeightsPosition(
        uint256 position,
        uint256 value
    ) external onlyOwner {
    ...
    function updateMultipliersPosition(
        uint256 position,
        uint256 value
    ) external onlyOwner {
